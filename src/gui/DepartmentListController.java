...
public class DepartmentListController implements Initializable, DataChangeListener {
	 ...
	 * department mais sem injetar a depenência dentro da classe, abaixo é criado a
	 * função setDepartmentService para poder injetar essa dependência em outro
	 * lugar no programa.
	 * 
	...
	public void onbtNewAction(ActionEvent event) {
		...
		/*
		 * Por ser um botão para cadastrar um novo department instancia-se um objeto
	...
	// Criado o setDepartmentSet para injetar a depenência do serviço em outro lugar
	// no programa.
	...
	private void initializeNodes() {
		...
		/*
		 * Macete para que a tableView que nesse caso é a tableViewDepartment, acompanhe
	...
	public void updateTableView() {
		 ...
		 * a injeção de dependência do servico que nesse caso é o setDepartmentService,
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) {
		...
		try {
			 ...
			 * notificações de evento implementada na classe DepartmentFormController, ao
